...
MOBILES := [Mobile_ID]BP_Mobile {
	...
	.Emu = {
		name = "Emu",
		desc = "A tall, aggressive, flightless bird rumored to have won a war",
		tile = .Emu,
		color = rl.WHITE,
		hp = 8,
		vision = 8,
	...
	.Hobgoblin = {
		name = "Hobgoblin",
		desc = "A large Hobgoblin, leader of the goblin tribes",
		tile = .Hobgoblin,
		color = rl.WHITE,
		hp = 10,
		vision = 7,
	...
	.Snake = {
		name = "Snake",
		desc = "A viper slithering between the cracks in the stone",
		tile = .Snake,
		color = rl.WHITE,
		hp = 5,
		vision = 6,
